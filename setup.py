...
setup(
    ...
    extras_require = {
        ...
        'discord': ['pypresence'],
        'all': ['Jinja2', 'pywebview>=3.3.1', 'pystray', 'Flask', 'Werkzeug', 'pypresence'],
    },
    python_requires='>=3.6',
    install_requires=['python-mpv', 'jellyfin-apiclient-python>=1.6.1', 'python-mpv-jsonipc>=1.1.9', 'requests'],
