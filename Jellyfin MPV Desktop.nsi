...
!define MAIN_APP_EXE "run-desktop.exe"
...
InstallDir "$LocalAppData\Programs\Jellyfin MPV Desktop"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Jellyfin MPV Desktop"
...
!ifdef WEB_SITE
WriteIniStr "$INSTDIR\${APP_NAME} website.url" "InternetShortcut" "URL" "${WEB_SITE}"
CreateShortCut "$SMPROGRAMS\Jellyfin MPV Desktop\${APP_NAME} Website.lnk" "$INSTDIR\${APP_NAME} website.url"
!endif
!endif
...
RmDir "$SMPROGRAMS\Jellyfin MPV Desktop"
!endif
